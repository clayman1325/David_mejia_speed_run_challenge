      ...
      <div className="flex items-center flex-col flex-grow pt-10">
        <div className="px-5 w-[90%] md:w-[75%]">
          <h1 className="text-center mb-6">
            <span className="block text-2xl mb-2">SpeedRunEthereum By David Mejia Bonilla</span>
            <span className="block text-4xl font-bold">Build your first NFT</span>
          </h1>
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="max-w-3xl">
              <p className="text-center text-lg mt-8">
                <small>🎫 Create a simple NFT to learn basics of 🏗️ Scaffold-ETH 2. You&apos;ll use 👷‍♀️
              ...
              <p className="text-center text-lg">
                <small>🌟 The final deliverable is an app that lets users purchase and transfer NFTs. Deploy your contracts to
